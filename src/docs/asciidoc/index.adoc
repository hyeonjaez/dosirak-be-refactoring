...
==== 1. Curl Request
include::{snippets}/store-detail-get-id-not-found/curl-request.adoc[]
==== 2. HTTP Request
include::{snippets}/store-detail-get-id-not-found/http-request.adoc[]
==== 3. HTTP Response
include::{snippets}/store-detail-get-id-not-found/http-response.adoc[]
==== 4. HTTP Request Headers
include::{snippets}/store-detail-get-id-not-found/httpie-request.adoc[]
==== 5. HTTP Request Body
include::{snippets}/store-detail-get-id-not-found/request-body.adoc[]
==== 6. HTTP Response Body
include::{snippets}/store-detail-get-id-not-found/response-body.adoc[]
==== 7. HTTP Response Parameter
include::{snippets}/store-detail-get-id-not-found/response-fields.adoc[]
